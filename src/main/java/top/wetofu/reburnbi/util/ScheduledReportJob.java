...
package top.wetofu.reburnbi.util;
...
import top.wetofu.reburnbi.engine.ChartReportEngine;
...
import top.wetofu.reburnbi.objects.ReportDeliveryLog;
...
import top.wetofu.reburnbi.scheduler.ScheduledReportCallback;
...
public class ScheduledReportJob	implements Job
{
		...
		throws JobExecutionException
	{
		...
		try
		{
            ...
            {
                deliveryMethods = new String[]{top.wetofu.reburnbi.ReportConstants.DeliveryMethod.EMAIL.getName()};
