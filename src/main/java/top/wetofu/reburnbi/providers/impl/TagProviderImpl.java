...
public class TagProviderImpl implements TagProvider
{
    ...
    {        
        ...
        queryString.append("select distinct orTag.tag from top.wetofu.reburnbi.objects.ORTag orTag ");
	...
	public void setTags(Integer objectId, Class objectClass, String tagString, String tagType) throws ProviderException
	{
		...
		try
		{
			...
			session
					.createQuery(
							"DELETE top.wetofu.reburnbi.objects.ORTag orTag where orTag.objectId = ? and orTag.objectClass = ? and orTag.tagType = ? ")
