...
import top.wetofu.reburnbi.providers.GroupProvider;
...
public class GroupProviderImpl implements GroupProvider
{
	...
	{
		String fromClause =
			"from top.wetofu.reburnbi.objects.ReportGroup reportGroup order by reportGroup.name ";
		...
		try
		{
			...
			{			
				List<ReportGroup> list = session.createQuery(
						"from top.wetofu.reburnbi.objects.ReportGroup as reportGroup "
