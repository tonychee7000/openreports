...
import top.wetofu.reburnbi.objects.*;
import top.wetofu.reburnbi.providers.*;
import top.wetofu.reburnbi.util.*;
...
public class ParameterProviderImpl implements ParameterProvider
{
	...
	{
		String fromClause =
			"from top.wetofu.reburnbi.objects.ReportParameter reportParameter order by reportParameter.name ";
